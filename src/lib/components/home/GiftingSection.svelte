<script lang="ts">
	let sendAsGift = $state(true);
</script>

<section class="section gifting-section">
	<div class="page-wrap gifting-layout">
		<div class="gift-visual glass-card">
